                        ...
                        <div className="container">
                            ...
                            <section id="contact">
                                ...
                                <Row>
                                    <Col lg="5" md="12">
                                        <form className="p-5">
                                            <div className="md-form form-sm"> <i className="fa fa-user prefix grey-text"></i>
                                                <input type="text" id="form3" className="form-control form-control-sm" />
                                                <label for="form3">Your name</label>
                                            </div>
                                            <div className="md-form form-sm"> <i className="fa fa-envelope prefix grey-text"></i>
                                                <input type="text" id="form2" className="form-control form-control-sm" />
                                                <label for="form2">Your email</label>
                                            </div>
                                            <div className="md-form form-sm"> <i className="fa fa-tag prefix grey-text"></i>
                                                <input type="text" id="form32" className="form-control form-control-sm" />
                                                <label for="form34">Subject</label>
                                            </div>
                                            <div className="md-form form-sm"> <i className="fa fa-pencil prefix grey-text"></i>
                                                <textarea type="text" id="form8" className="md-textarea form-control form-control-sm" rows="4"></textarea>
                                                <label for="form8">Your message</label>
                                            </div>
                                            <div className="text-center mt-4">
                                                <button className="btn btn-primary">Send <i className="fa fa-paper-plane-o ml-1"></i></button>
                                            </div>
                                        </form>
                                    </Col>
                                    <Col lg="7" md="12">
