...
class MDBHomePage extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <View waves >
                    <img src={bannerImage} style={{ width: '100%', height: '600px' }} className="img-fluid" alt="" />
                    <Mask overlay="black-strong" className="flex-center">
                        <div className="container-fluid d-flex align-items-center justify-content-center h-0">
